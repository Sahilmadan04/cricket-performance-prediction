...
df = df.dropna(subset=["player", "venue", "opposition", "wickets", "recent_form_avg_wkts", "date"])
...
input_seq = last_5[["recent_form_avg_wkts", "venue_enc", "oppo_enc"]].values.astype(np.float32)

# -----------------------------
# Step 4: Load trained model
# -----------------------------
model = LSTMPredictor(input_dim=3)
model.load_state_dict(torch.load("models/lstm_bowling_t20.pt"))
model.eval()
